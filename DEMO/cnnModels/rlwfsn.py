...
""" Class: __Saturation_unit__
    Description:  This class implements the LET saturation unit used in 
            the rLWFSN CNN 
    constructor:
...
"""
class __saturation_unit__(nn.Module):
    def __init__(self, nts):
        super(__saturation_unit__, self).__init__()
    ...
    def forward(self, D):
        ...
        return(  D - out.reshape([ds[0], ds[1], ds[2], ds[3]]) )
...
""" Class: lwfsn_2d 
    ...
    forward outputs:
        * LL: Denoised image
"""
class rlwfsn_2d(nn.Module):
    def __init__( self, in_channels=1, depth=1, wf=4):
        super(rlwfsn_2d, self).__init__()
        self.depth = depth
